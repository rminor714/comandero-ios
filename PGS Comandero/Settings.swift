...
let rootUrl = URL(string: "https://comandero.pargolfsolutions.com")!
// let rootUrl = URL(string: "http://192.168.0.178:8081")!

// allowed origin is for what we are sticking to pwa domain
// This should also appear in Info.plist
let allowedOrigins: [String] = ["comandero.pargolfsolutions.com", "192.168.0.178:8081"]
